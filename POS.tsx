...
import { Search, ShoppingCart, Minus, Plus, Trash2, CreditCard, Banknote, QrCode, Clock, FileText, Bike, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto pr-2 grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 pb-20 md:pb-0">
          {filteredProducts.map(product => (
            ...
            >
              <div className="h-24 w-full bg-rose-50 rounded-lg mb-3 flex items-center justify-center overflow-hidden">
                {product.imageUrl ? (
                   <img 
                  ...
                  <div className="bg-rose-50 w-full h-full flex items-center justify-center text-rose-300">
                    <ImageIcon size={32} />
                  </div>
                )}
              </div>
              ...
              <div key={item.id} className="flex items-center gap-3">
                <div className="w-12 h-12 bg-gray-100 rounded-lg overflow-hidden shrink-0">
                  {item.imageUrl ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-50 text-gray-300"><ImageIcon size={16}/></div>
                  )}
                </div>
